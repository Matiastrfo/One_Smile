        ...
        <div className="md:col-span-1">
          <div className="bg-card border border-border/60 rounded-2xl p-6 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-muted-foreground">Contraseña <span className="font-normal">(opcional)</span></label>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-card border border-border rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
            ...
            <form onSubmit={handleEditSubmit} className="p-5 space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-muted-foreground">Nueva contraseña <span className="font-normal">(dejá vacío para no cambiar)</span></label>
